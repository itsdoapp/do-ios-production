...
struct WalkingWorkoutView: View {
    ...
    var body: some View {
        ZStack {
            AmbientBackground(color: .blue, heartRate: metrics.heartRate)
    ...
    private func sendLocationDataToPhone() {
        ...
        print("📍 [WalkingWorkoutView] Sent \(locationData.count) locations to phone")
    }
    ...
    private func updateMetrics() {
        ...
        if let healthKitMetrics = healthKitManager.getCurrentMetrics() {
            ...
            metrics.cadence = healthKitMetrics.cadence
        } else {
