...
struct MeditationPlayerView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 32) {
                    ...
                    ZStack {
                        // Character illustration matching ModernMeditationTrackerViewController style
                        MeditationCharacterView(category: mapFocusToCategory(meditation.focus))
                            .frame(width: 120, height: 120)
                            .scaleEffect(audioService.isSpeaking ? 1.05 : 1.0)
                            .animation(.easeInOut(duration: 2.0).repeatForever(autoreverses: true), value: audioService.isSpeaking)
    ...
    private func logMeditationSession() {
    ...
    private func stopAllMeditationAudio() {
    ...
    private func ambientTypeForFocus(_ focus: String) -> AmbientSoundType {
    ...
    private func parseScriptForCounting() {
    ...
    private func startScriptParsing() {
